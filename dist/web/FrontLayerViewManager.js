...
var FrontLayerViewManager = /** @class */ (function () {
    ...
    FrontLayerViewManager.prototype.setMainView = function (element, shouldHydrate) {
    ...
    FrontLayerViewManager.prototype._renderRootView = function (shouldReactDOMHydrate) {
        var _this = this;
